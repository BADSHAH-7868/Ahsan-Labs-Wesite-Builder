...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white overflow-hidden relative">
      ...
      >
        {/* Header */}
        <header className="mt-9 relative z-10 p-6">
          <motion.div
          ...
          >
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <div className="absolute -top- -right-1 w-3 h-3 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full animate-pulse"></div>
              </div>
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
          ...
          >
            <h2 className="text-6xl font-bold mb-6 bg-gradient-to-r from-white via-cyan-200 to-purple-300 bg-clip-text text-transparent">
              Build Websites with
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.id} className="flex items-center">
                  ...
                  <span className={`ml-3 text-sm font-medium ${isActive ? 'text-cyan-400' : isCompleted ? 'text-green-400' : 'text-gray-400'
                    }`}>
                    {step.label}
                  </span>
                  {index < steps.length - 1 && (
                    <div className={`w-16 h-0.5 ml-8 ${isCompleted ? 'bg-green-400' : 'bg-gray-600'
                      }`} />
                  )}
                </div>
              );
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-400">Made By Ahsan Labs</span>
            </div>
            <div className="flex space-x-6 text-sm text-gray-400">
              ...
              <a href="https://wa.me/923343926359?text=Assalamualikum%20Ahsan%2C%20I%20Am%20From%20Your%20AI%20Website%20Builder
" className="hover:text-cyan-400 transition-colors" target='blank' >Message Owner</a>
